...
int Menu::getInputEventLoop() const {
  ...
  while (!done) {
    ...
    while (SDL_PollEvent(&event)) {
      ...
      io.writeText("Press R : Restart", hudFrame.x + offset_w, hudFrame.y + 250);
      io.writeText("Press T : Change track object", hudFrame.x + offset_w, hudFrame.y + 290);
      io.writeText("Press space : Shooting ", hudFrame.x + offset_w, hudFrame.y + 330);
      io.writeText("Press M : Menu ", hudFrame.x + offset_w, hudFrame.y + 370);
...
void Menu::draw() const {
  drawBackground();
  io.writeText("Options Menu", hudFrame.x + 380, hudFrame.y + 60);
  int space = spaces;
